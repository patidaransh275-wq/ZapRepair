      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 bg-white p-8 sm:p-12 rounded-3xl border border-slate-200 shadow-soft-sm">
        ...
        <div className="space-y-6 text-xs sm:text-sm text-slate-700 leading-relaxed">
          ...
          <section className="space-y-2">
            ...
            <p>
              Your contact details and service address are used exclusively to dispatch background-verified technicians to your home, provide live service tracking updates, issue digital invoices, and communicate regarding customer support queries.
            </p>
          </section>
